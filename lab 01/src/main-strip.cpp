...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(500, 500, "INF01047 - 00303397 - João Pedro Silveira e Silva", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
...
GLuint BuildTriangles()
{
    ...
    GLfloat NDC_coefficients[] = {
        ...
        // Outer Circle
        // Center Up
        cos_degree(90.0) * outer_hyp, sin_degree(90.0) * outer_hyp, z, w,
        // Up Right
        cos_degree(67.5) * outer_hyp, sin_degree(67.5) * outer_hyp, z, w, 
        cos_degree(45.0) * outer_hyp, sin_degree(45.0) * outer_hyp, z, w,
        cos_degree(22.5) * outer_hyp, sin_degree(22.5) * outer_hyp, z, w,
        // Center Right
        cos_degree(0.0) * outer_hyp, sin_degree(0.0) * outer_hyp, z, w, 
        // Down Right
        cos_degree(337.5) * outer_hyp, sin_degree(337.5) * outer_hyp, z, w, 
        cos_degree(315.0) * outer_hyp, sin_degree(315.0) * outer_hyp, z, w,
        cos_degree(292.5) * outer_hyp, sin_degree(292.5) * outer_hyp, z, w,
        // Center Down
        cos_degree(270.0) * outer_hyp, sin_degree(270.0) * outer_hyp, z, w,
        // Down Left
        cos_degree(247.5) * outer_hyp, sin_degree(247.5) * outer_hyp, z, w,
        cos_degree(225.0) * outer_hyp, sin_degree(225.0) * outer_hyp, z, w,
        cos_degree(202.5) * outer_hyp, sin_degree(202.5) * outer_hyp, z, w,
        // Center Left
        cos_degree(180.0) * outer_hyp, sin_degree(180.0) * outer_hyp, z, w, 
        // Up Left
        cos_degree(157.5) * outer_hyp, sin_degree(157.5) * outer_hyp, z, w,
        cos_degree(135.0) * outer_hyp, sin_degree(135.0) * outer_hyp, z, w,
        cos_degree(112.5) * outer_hyp, sin_degree(112.5) * outer_hyp, z, w,

        // Inner Circle
        // Center Up
        cos_degree(90.0) * inner_hyp, sin_degree(90.0) * inner_hyp, z, w,
        // Up Right
        cos_degree(67.5) * inner_hyp, sin_degree(67.5) * inner_hyp, z, w, 
        cos_degree(45.0) * inner_hyp, sin_degree(45.0) * inner_hyp, z, w,
        cos_degree(22.5) * inner_hyp, sin_degree(22.5) * inner_hyp, z, w,
        // Center Right
        cos_degree(0.0) * inner_hyp, sin_degree(0.0) * inner_hyp, z, w, 
        // Down Right
        cos_degree(337.5) * inner_hyp, sin_degree(337.5) * inner_hyp, z, w, 
        cos_degree(315.0) * inner_hyp, sin_degree(315.0) * inner_hyp, z, w,
        cos_degree(292.5) * inner_hyp, sin_degree(292.5) * inner_hyp, z, w,
        // Center Down
        cos_degree(270.0) * inner_hyp, sin_degree(270.0) * inner_hyp, z, w,
        // Down Left
        cos_degree(247.5) * inner_hyp, sin_degree(247.5) * inner_hyp, z, w,
        cos_degree(225.0) * inner_hyp, sin_degree(225.0) * inner_hyp, z, w,
        cos_degree(202.5) * inner_hyp, sin_degree(202.5) * inner_hyp, z, w,
        // Center Left
        cos_degree(180.0) * inner_hyp, sin_degree(180.0) * inner_hyp, z, w, 
        // Up Left
        cos_degree(157.5) * inner_hyp, sin_degree(157.5) * inner_hyp, z, w,
        cos_degree(135.0) * inner_hyp, sin_degree(135.0) * inner_hyp, z, w,
        cos_degree(112.5) * inner_hyp, sin_degree(112.5) * inner_hyp, z, w,
    };
